...
public class OrderUpdater {
  ...
  private static String pizzaUpdateMessage =
      "What do you want to update? Please enter Size/Type/Topping.\n"
  ...
  private static void updatePizza(Scanner scanner, Order myOrder) {
    ...
    System.out.println(
        "Which pizza do you want to update? "
    ...
    if (pizzaNumber == 0) {
      ...
      while (!option.equals("Confirm")) {
        ...
        if (option.equals("Size")) {
          System.out.println(
              "What size do you want? Please enter "
        ...
        if (option.equals("Type")) {
          System.out.println(
              "What type do you want? Please enter "
        ...
        if (option.equals("Topping")) {
          System.out.println(
              "Which topping do you want to update? Please enter "
          ...
          myOrder.updatePizzaByIndex(
              pizzaNumber, 3, toppingToQuantity.get(0), Integer.parseInt(toppingToQuantity.get(1)));
      ...
      System.out.println(
          "Your pizza has been confirmed. If you want to update anything else, "
  ...
  private static void updateDrink(Scanner scanner, Order myOrder) {
    ...
    System.out.println(
        "You can update the quantity of any drinks that you have ordered or add new drinks.\n"
            + "Please enter "
            + Handler.convertSetToString(PizzaParlour.allDrinks)
            + ".");
